...
public class PegacornAsServerExternalIPCConnection extends IPCConnection {
    private static final Logger LOG = LoggerFactory.getLogger(PegacornAsServerExternalIPCConnection.class);
